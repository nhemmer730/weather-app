...
function displayForecast(response) {
  let forecast =response.data.daily;
    ...
    forecastHTML =
        ...
        `        
        <div class="col-2">
        <div class="weather-forecast-date">${forecastDay.daily}</div>
          <img src="http://shecodes-assets.s3.amazonaws.com/api/weather/icons/${forecastDay.daily[0].condition.icon}.png" />
       <div class="weather-forecast-temperatures">
         <span class="weather-forecast-max">${forecastDay.daily.temperature.maximum} ° </span>
          <span class="weather-forecast-min">${forecastDay.daily.temperature.minimum} °  </span>
        </div>
     </div>
      `;
     });
